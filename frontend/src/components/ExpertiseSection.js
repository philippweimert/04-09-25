  ...
  return (
    <section className="bg-slate-800 py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        >
          <polygon
            points="0,150 300,150 300,75 150,0 0,75"
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <p className="text-body text-slate-300 mb-8 max-w-2xl mx-auto">
            Mit über 30 Jahren Erfahrung unterstützen wir Unternehmen dabei, die
            betriebliche Altersvorsorge effizient und rechtssicher zu verwalten.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="text-left">
              <h3 className="text-lg font-semibold text-white mb-3 text-headline">
                Unsere Expertise zeichnet uns aus.
              </h3>
