  ...
  const unternehmensvorteile = [
    {
      ...
      description:
        'Erhebliche Einsparungen bei Lohnsteuer und Sozialversicherungsbeiträgen durch digitalisierte Verwaltungsprozesse und optimale bAV-Gestaltung auf kostenneutraler Basis.',
    },
    {
      icon: <TrendingUp className="w-8 h-8" />,
      title: 'Effizienzsteigerung & Zeitersparnis',
      description:
        "Bis zu 80% weniger Verwaltungsaufwand durch vollautomatisierte Prozesse. Wir übernehmen das 'Daily Business' Ihrer bAV-Verwaltung für maximale Fokussierung auf Ihr Kerngeschäft.",
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: 'Risikominimierung & Rechtssicherheit',
      description:
        'Vollständige Compliance-Sicherstellung und Schutz vor rechtlichen Risiken durch komplexe rechtliche Prüfprozesse und permanente Überwachung aller Gesetzesänderungen.',
    },
    {
      icon: <Network className="w-8 h-8" />,
      title: 'Schnellere Bearbeitung',
      description:
        'Wir automatisieren Ihre Workflows und übernehmen alle wichtigen Prozesse in der laufenden bAV-Verwaltung.',
    },
    {
      icon: <Handshake className="w-8 h-8" />,
      title: 'Mitarbeiterbindung',
      description:
        'Innovative Vorsorgemodelle sowie eine moderne Mitarbeiterkommunikation und -beratung bieten attraktive Benefits.',
    },
    {
      icon: <Coffee className="w-8 h-8" />,
      title: 'HR-Entlastung',
      description:
        'Unser persönlicher Support unterstützt Sie als Partner proaktiv bei Anpassungs- oder Veränderungsmaßnahmen.',
    },
  ];
  ...
  const mitarbeitervorteile = [
    {
      ...
      description:
        'Aufbau einer zusätzlichen Rente durch Entgeltumwandlung mit staatlicher Förderung und Arbeitgeberzuschuss.',
    },
    {
      icon: <DollarSign className="w-8 h-8" />,
      title: 'Steuer- und Sozialabgaben-Ersparnis',
      description:
        'Reduzierung der Steuerlast und Sozialversicherungsbeiträge durch steuerlich geförderte Beiträge zur bAV.',
    },
    {
      icon: <Heart className="w-8 h-8" />,
      title: 'Arbeitgeberfinanzierung',
      description:
        'Mindestens 15% Zuschuss vom Arbeitgeber zusätzlich zur eigenen Entgeltumwandlung seit 2019/2022.',
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: 'Versorgungssicherheit',
      description:
        'Garantierte Leistungen und Schutz der Anwartschaften durch gesetzliche Regelungen und Pensionssicherungsverein.',
    },
    {
      icon: <Briefcase className="w-8 h-8" />,
      title: 'Portabilität',
      description:
        'Mitnahme der bAV-Anwartschaften bei Arbeitgeberwechsel - die Vorsorge bleibt erhalten.',
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: 'Einfache Abwicklung',
      description:
        'Vollautomatische Verwaltung ohne Aufwand für den Mitarbeitenden - alles läuft über die Lohnabrechnung.',
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: 'Persönliche Beratung',
      description:
        'Individuelle Beratung und Aufklärung über die optimale bAV-Gestaltung für die persönliche Situation.',
    },
    {
      icon: <TrendingUp className="w-8 h-8" />,
      title: 'Renditechancen',
      description:
        'Attraktive Renditemöglichkeiten durch professionelle Kapitalanlage und moderne Versorgungskonzepte.',
    },
  ];

  const currentBenefits =
    activeTab === 'unternehmen' ? unternehmensvorteile : mitarbeitervorteile;
  ...
  return (
    <section className="bg-gradient-to-b from-acencia via-acencia-light to-acencia py-12 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.08]">
        ...
        >
          <polygon
            points="200,60 300,120 300,180 200,240 100,180 100,120"
            fill="none"
            stroke="#e3ebf2"
            strokeWidth="1"
            opacity="0.6"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-2xl lg:text-3xl font-bold text-white mb-6 font-heading">
            Die konkreten{' '}
            <span className="text-orange-400">Vorteile für Sie</span>
          </h2>
