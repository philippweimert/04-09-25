          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center">
              ...
              <p className="text-lg text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed">
                Haben Sie Fragen zur betrieblichen Altersvorsorge? Wir sind für
                Sie da!
              </p>
            </div>
          </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    {contactInfo.map((info, index) => (
                      <Card
                        key={index}
                        className="border-slate-200 hover:border-orange-500 transition-colors duration-200"
                      >
                ...
                <Card className="bg-slate-900 border-slate-800">
                  <CardContent className="p-6">
                    ...
                    <p className="text-slate-300 mb-6">
                      Buchen Sie direkt einen Beratungstermin in unserem
                      Online-Kalender.
                    </p>
                    <Button
                      size="lg"
